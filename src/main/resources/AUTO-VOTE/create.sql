...
CREATE TABLE TASK_INDEX (  
  TASK_NANE varchar(20) NOT NULL,  
  TASK_CATE int(1),  
  IP_TYPE int(1),  
  DOWNLOAD_ADDRESS varchar(40),  
  IS_VALID int(1),  
  PRIMARY KEY (TASK_NANE)  
...
CREATE TABLE TASK_VS_BACKGROUND (  
  ...
  PRIMARY KEY (TASK_NANE,BACKGROUND_NO)  
)  DEFAULT CHARSET=utf8; 
...
CREATE TABLE TASK_REWARD (  
  ...
  PRIMARY KEY (TASK_NANE,BACKGROUND_NO,USER_ID,WORK_ID,SUB_ID)  
)  DEFAULT CHARSET=utf8; 