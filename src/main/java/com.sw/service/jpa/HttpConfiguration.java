...
public class HttpConfiguration {
    ...
    public static final Duration DEFAULT_MAX_IDLE_TIME = new Duration(1, Duration.Unit.MINUTES);
    ...
    public static final Duration DEFAULT_IDLE_TIMEOUT = new Duration(30, Duration.Unit.SECONDS);
